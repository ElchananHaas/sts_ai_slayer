...
type FResult = Result<(), std::fmt::Error>;

fn render_player(widget: &mut Widget, state: &ChoiceState) -> FResult {
    let game = state.game();
...
fn render_card(widget: &mut Widget, state: &ChoiceState, card_idx: usize) -> FResult {
    let game = state.game();
...
fn render_cards(widget: &mut Widget, state: &ChoiceState) -> FResult {
...
fn render_enemy(widget: &mut Widget, state: &ChoiceState, enemy_idx: usize) -> FResult {
    let game = state.game();
...
fn render_enemies(widget: &mut Widget, state: &ChoiceState) -> FResult {
...
fn render_battlefield(widget: &mut Widget, choice_state: &ChoiceState) -> FResult {
