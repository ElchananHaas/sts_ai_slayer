...
use crate::{ game::{encounter::{Encounter}, event::{Event, EventRoom}, Choice, EventAction, Game}, rng::Rng};
...
impl EventRoom for DeadAdventurer {
            ...
            1 => {
                ...
                if elite_arrived {
                    ...
                    if self.elite == DeadAdventurerElite::Lagavulin {
                        ...
                        game.fight.enemies[0].as_mut().expect("Enemy generated").ai_state = 5;
                    }
                    let mut gold = 0;
                    let mut relics = 0;
    ...
    fn action_str(&self, _game: &Game, action: EventAction) -> String {
        match action.0 {
            0 => "Leave".to_string(),
            1 => format!("Loot. {}% chance elite arrives.", self.elite_arrives_chance()),
            _ => panic!("Invalid action: {}.", action.0),
        }
    }
    ...
    fn new(rng: &mut Rng) -> Self {
        ...
        Self { elite, loots: smallvec![DeadAdventurerLoot::Nothing, 
                                       DeadAdventurerLoot::Gold,
                                       DeadAdventurerLoot::Relic]}
    }
